...
public class UsuarioAdapter extends ArrayAdapter {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent){
        ...
        txtUsername.setText(String.format("USERNAME:%s", usuarios.get(position).getNombre()));
        txtPassword.setText(String.format("PASSWORD:%s", usuarios.get(position).getClave()));
